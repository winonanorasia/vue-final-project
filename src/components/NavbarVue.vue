...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top w-100">
    <div class="container">
      <router-link to="/" class="navbar-brand">
        <img src="/assets/img/fashion-shop-luxury.jpg" alt="" width="60" class="d-inline-block align-text-top">
        Fashion Shop
      </router-link>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div>
          <router-link to="/ourstore">
            <button class="button-primary">Our Store</button>
          </router-link>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer me-2">
            <a class="nav-link fst-italic" href="#">Forgot Password</a>
            <button type="button" class="button-secondary rounded-pill">Login</button>
          </div>
        </div>
      </div>
    </div>
